...
import { EQ_OR_GT_1_3_0 } from "./constants.js"
import type { EIP712TxTypes, EIP712TypedData, SafeEIP712Args, TypedMessageTypes } from "./types.js"

export function generateSafeTypedData(args: SafeEIP712Args): EIP712TypedData {
  const { chainId, data, safeAddress, safeVersion } = args
  ...
  const types: TypedMessageTypes = {
    ...
    SafeTx: txTypes.SafeTx as Array<TypedDataParameter>
  }
...
const EIP712_DOMAIN_WITH_CHAIN: Array<TypedDataParameter> = [
  { name: "chainId", type: "uint256" },
  { name: "verifyingContract", type: "address" }
]

const EIP712_DOMAIN_NO_CHAIN: Array<TypedDataParameter> = [
  { name: "verifyingContract", type: "address" }
]
